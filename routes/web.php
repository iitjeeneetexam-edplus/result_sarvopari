...
Route::post('/student/update-student-ranks', [StudentController::class, 'update_student_ranks'])->name('students.update-student-ranks');
...
Route::post('/student/single-exam-marksheet-guj', [StudentController::class, 'mark_marksheet_guj'])->name('students.final_marksheet_guj');
