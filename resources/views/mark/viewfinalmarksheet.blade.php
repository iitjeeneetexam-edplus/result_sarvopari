...
<div style="box-sizing: border-box;">
    <div style="font-family: system-ui, sans-serif; ">
        ...
        <div style="width: auto; height: 265mm; padding: 10px; border: 3px solid black; border-radius: 4px; font-family: Calibri, sans-serif;">
...
<table class="custom-table">
    <thead>
        ...
        @endphp
            ...
            <table border="1" cellspacing="0" cellpadding="5" style="width: auto; border-collapse: collapse; text-align: center; border: 1px solid black;">
            <thead>
                    <tr>
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Subjects</th>
                        @if(isset($student_value['exam']))
                        @foreach($student_value['exam'] as $exam_value)
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">{{$exam_value['exam_name']}}</th>
                        @endforeach
                        @endif
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Obtain Marks</th>
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Out of 100</th>
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Performance</th>
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Grace</th>
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Grade</th>
                        <th style="background-color: #f0f0f0;border: 1px solid black;width:auto;">Percentage</th>
                    </tr>
